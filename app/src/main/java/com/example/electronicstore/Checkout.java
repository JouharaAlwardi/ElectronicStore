...
public class Checkout extends AppCompatActivity {
    ...
    public void adjustStock(String name) {
    ...
    public void setDate(String key,String category, String image, String manufacturer, String price, String stock, String title) {
